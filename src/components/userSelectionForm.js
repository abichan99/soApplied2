...
const DROPDOWN_LIST_VALS = {
    ...
    destinationStation: {label: "select a destination station", id: "destination-station-list", optInitVal: "종착역을 선택"},
};
        ...
        return (
            <div>
                ...
                <form className="inline-flex flex-col">
                    ...
                    <DropdownList vals={DROPDOWN_LIST_VALS.destinationStation} options="" onChangeMode={()=>{}}></DropdownList>
...
function setOptionsByLine(line) {
    ...
    removeExceptDefaultOption([DROPDOWN_LIST_VALS.departureStation.id, DROPDOWN_LIST_VALS.destinationStation.id])
}
/**
...
function setOptionsByDirection(line, direction) {
    ...
    const destinationStationSelectElemID = DROPDOWN_LIST_VALS.destinationStation.id;
